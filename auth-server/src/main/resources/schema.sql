...
VALUES ('1', 'lakitha','{bcrypt}$2a$10$rOdDznpjsrvAVpLv71x/S.UTbipbOefuBb4hsptm3TXRaOagnsgyq', 'l@lakitha.com', '1', '1', '1', '1');
 insert into  user (id, username,password, email, enabled, accountNonExpired, credentialsNonExpired, accountNonLocked)
 VALUES ('2', 'prabudh', '{bcrypt}$2a$10$rOdDznpjsrvAVpLv71x/S.UTbipbOefuBb4hsptm3TXRaOagnsgyq','p@lakitha.com', '1', '1', '1', '1');

INSERT INTO role_user (role_id, user_id)
    VALUES
    (1, 1) /* lakitha-admin */,
    (2, 2) /* prabudh-operatorr */ ;